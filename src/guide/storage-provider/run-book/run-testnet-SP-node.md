...
P2PPrivateKey = '' # recommend writing this config to environment variables
...
We recommend you writing  db User, db password, db address, bucketURL, OperatorPrivateKey, FundingPrivateKey, SealPrivateKey, ApprovalPrivateKey and GcPrivateKey in environment variables for safety.
